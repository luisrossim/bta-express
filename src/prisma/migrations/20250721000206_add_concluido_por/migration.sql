...
-- AddForeignKey
ALTER TABLE "historico_os" ADD CONSTRAINT "historico_os_concluido_por_fkey" FOREIGN KEY ("concluido_por") REFERENCES "usuarios"("id") ON DELETE SET NULL ON UPDATE CASCADE;
